...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            <li><a><i class="fa fa-home"></i> Modulo Contabilidad <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                    <li><a href="<?php echo SERVERURL; ?>home/">Plan  de Cuentas </a></li>
                    <li><a href="<?php echo SERVERURL; ?>home/">Liro Diario </a></li>
                    <li><a href="<?php echo SERVERURL; ?>perfil/"> Mayores Generales</a></li>
                    <li id="al"><a > Bancos </a>
                        <ul>
                            <li style="list-style: none;padding:0.01px;">
                                <a href="<?php echo SERVERURL; ?>perfil/">Concisionaria Bancaria</a>
                            </li>
                        </ul>
                    </li>
                    <li><a> Estados Financieros</a>
                        <ul>
                            <li style="list-style: none;padding:0.01px;">
                                <a href="<?php echo SERVERURL; ?>perfil/">Balance de Situcacion Finaciera.</a>
                            </li>
                            <li style="list-style: none;padding:0.01px;">
                                <a href="<?php echo SERVERURL; ?>perfil/">Balance de Resultados.</a>
                            </li>
                        </ul>
                    </li>
                    <li><a href="<?php echo SERVERURL; ?>/"> Genberar ATS</a></li>
                    <li><a href="<?php echo SERVERURL; ?>/">Informacación personal</a></li>


                </ul>
            </li>
            <li><a><i class="fa fa-institution"></i>Inventario <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                      <li><a>Articulo</a>
                        <ul>
                            <li style="list-style: none;padding:0.01px;">
                                <a href="<?php echo SERVERURL; ?>perfil/">Reporte de Inventario Vedido.</a>
                            </li>
                            <li style="list-style: none;padding:0.01px;">
                                <a href="<?php echo SERVERURL; ?>perfil/">Reporte de Inventario Disponible.</a>
                            </li>
                            <li style="list-style: none;padding:0.01px;">
                                <a href="<?php echo SERVERURL; ?>perfil/">Promociones.</a>
                            </li>
                        </ul>
                    </li>
                    <br>
                    <!-- <li><a href="<?php echo SERVERURL; ?>departamentos/">Cardex</a></li> -->
                    <li><a href="<?php echo SERVERURL; ?>departamentos/"><i></i>Cardex</a></li>
                </ul>
            </li>
        </ul>
        ...
        <!--<br>
            ...
            <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-users"></i> Ventas  dd <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
        ...
        <!--<br>
            ...
            <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-users"></i> Compras <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="<?php echo SERVERURL; ?>plancuentas/">Facturación</a></li>
                        <li><a href="<?php echo SERVERURL; ?>plancuentas/">Retenciones</a></li>
                        <li><a href="<?php echo SERVERURL; ?>plancuentas/">Clientes</a></li>
        ...
        <!--<br>
            ...
            <ul class="nav side-menu">
                ...
                <li><a><i class="fa fa-users"></i> Plan de cuentas <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="<?php echo SERVERURL; ?>plancuentas/">Plan de cuentas</a></li>
                    </ul>
                </li>

                <li><a><i class="fa fa-users"></i> Libro diario <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="<?php echo SERVERURL; ?>librodiario/">Libro diario</a></li>
                    </ul>
                </li>

                <li><a><i class="fa fa-users"></i> Mayores generales <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="<?php echo SERVERURL; ?>mayoresgenerales/">Mayores generales</a></li>
                    </ul>
                </li>

                <li><a><i class="fa fa-users"></i> Bancos <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="<?php echo SERVERURL; ?>consiliacionbancaria/">Consiliación Bancaria</a></li>
                    </ul>
                </li>

                <li><a><i class="fa fa-users"></i> Estados financieros <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        <li><a href="<?php echo SERVERURL; ?>balancefinanciero/">Balance de situación financiera</a></li>
                        <li><a href="<?php echo SERVERURL; ?>balanceresultados/">Balance de resultados</a></li>
                    </ul>
                </li>
