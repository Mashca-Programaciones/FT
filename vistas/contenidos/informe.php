        ...
        <div class="ln_solid">
            <div class="form-group">
                <div style="display: block; margin-left: auto; margin-right: auto;">
                    ...
                    <a style="display: block; margin-left: 45%; margin-right: 45%;"  href="<?php echo SERVERURL; ?>Reportes/Reporte.php?Cod=<?php echo $verificar;?>&Res=<?php echo trim($consultaNomres);?>&Vis=<?php echo trim($consultaNom);?>" title="Visualizar Informe" target="_blank" class="btn btn-primary">
